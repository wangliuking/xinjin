...
public class ExcelUtil {
    ...
    public static void exportExcel(HttpServletResponse response,
        ...
        String[] headers = { "行政区域", "机构名称", "站点名称", "RTU-ID","SPD路数","型号","名称","安装位置","状态","记录时间"};
        ...
        for (Map<String,Object> map : excelData) {
            ...
            row1.createCell(4).setCellValue(map.get("spd_number")+"");
            row1.createCell(5).setCellValue(map.get("spd_model")+"");
            row1.createCell(6).setCellValue(map.get("spd_name")+"");
            row1.createCell(7).setCellValue(map.get("spd_location")+"");
            row1.createCell(8).setCellValue(map.get("spd_state")+"");
            row1.createCell(9).setCellValue(map.get("write_time")+"");
            rowNum++;
        }
